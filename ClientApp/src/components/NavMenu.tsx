...
export class NavMenu extends Component<{}, { collapsed: boolean }>{
    ...
    render()
    {
        ...
        const discordAuthLink = `https://discord.com/api/oauth2/authorize?client_id=225369871393882113&redirect_uri=${baseUrl}%2Fapi%2FDiscord%2FCallback&response_type=code&scope=guilds%20identify`;
        return (
